...
public class RedisUtil {
    ...
    public Set<String> getKeysList(String keys) {
        return Optional.ofNullable(redisTemplate.keys(keys)).orElseThrow(() -> new MyException(ReturnMsg.CACHE_FUZZY_MATCH_KEY_FAILED));
    }

    /**
     * 删除
     */
    public void del(Set<String> keyLists) {
        Optional.ofNullable(redisTemplate.delete(keyLists)).orElseThrow(() -> new MyException(ReturnMsg.CACHE_DELETION_FAILED));
    }
